...
class d2016 extends React.Component {
    ...
    async componentDidMount() {
        var response = await fetch('http://localhost:8080/TableOne');
        var response2 = await fetch('http://localhost:8080/PlayerOne');
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <Tabs className="tabsy1">
                                    ...
                                    <hr className="Linia" />
                                    <TabPanel >
                                        <div className="sezon">Sezon 2015/2016</div>
                                        <div class="row">
                                            <div class="col">
                                                <div className="tekst">

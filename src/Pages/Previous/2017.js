...
class d2017 extends Component {
    ...
    async componentDidMount() {
        var response = await fetch('http://localhost:8080/TableTwo');
        var response2 = await fetch('http://localhost:8080/PlayerTwo');
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <Tabs className="tabsy1">
                                    ...
                                    <hr className="Linia" />
                                    <TabPanel >
                                        <div className="sezon">Sezon 2016/2017</div>
                                        <div class="row">
                                            <div class="col">
                                                <div className="tekst">

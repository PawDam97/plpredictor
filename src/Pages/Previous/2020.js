...
class d2020 extends Component {
    ...
    async componentDidMount() {
        var response = await fetch('http://localhost:8080/TableFive');
        var response2 = await fetch('http://localhost:8080/PlayerFive');
